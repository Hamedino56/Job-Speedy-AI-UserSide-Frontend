...
const AboutPage = () => {
  ...
  const content = {
    de: {
      ...
      forCompanies: "Stellenausschreibungen lassen sich in Sekunden mit KI erstellen. Alle Prozesse laufen zentral über ein übersichtliches Dashboard – für weniger Aufwand und bessere Entscheidungen.",
    ...
    en: {
      ...
      forCompanies: "Job postings can be created in seconds with AI. All processes run centrally through a clear dashboard – for less effort and better decisions.",
