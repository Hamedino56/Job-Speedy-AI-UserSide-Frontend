...
const AboutPage = () => {
  ...
  const content = {
    de: {
      ...
      forCompanies: "Stellenausschreibungen lassen sich in Sekunden mit KI erstellen, Lebensläufe werden automatisch an die ausgeschrieben Stellen gesendet. Persönlichkeitsrechte werden beachtet, berücksichtigt und eingehalten. Eine Diskriminierung ist somit ausgeschlossen. Alle Prozesse laufen zentral über ein übersichtliches Dashboard – für weniger Aufwand und bessere Entscheidungen.",
    ...
    en: {
      ...
      forCompanies: "Job postings can be created in seconds with AI, resumes are automatically sent to the advertised positions. Personal rights are respected, considered and complied with. Discrimination is thus excluded. All processes run centrally through a clear dashboard – for less effort and better decisions.",
